...
const directLineTokenEp = `https://directline.botframework.com/v3/directline/tokens/generate`;
...
app.post('/chatBot', async function(req, res) {
  console.log("Received chat bot request...");
  ...
  try {
      ...
      const statusCode = err.statusCode || 500; // Use 500 if statusCode is undefined
      res.status(statusCode).send();
