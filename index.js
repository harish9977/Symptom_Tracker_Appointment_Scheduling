const defaultLocale = 'centralindia';


function requestChatBot(loc) {
    console.log("Requesting chat bot...");
...
function chatRequested() {
    console.log("Checking chat request...");
    const params = new URLSearchParams(location.search);
...
function initBotConversation() {
    ...
    const styleOptions = {
        botAvatarImage: 'https://docs.microsoft.com/centralindia/azure/bot-service/v4sdk/media/logo_bot.svg?view=azure-bot-service-4.0',
        // botAvatarInitials: '',
        // userAvatarImage: '',
